...
func (t *TaskExportRekapitulasi) Consume(d rmq.Delivery) {
	...
	opdname = usecase.ReportUseCase(t.DB).GetOpdName(d.Payload())
	...
	// get data
	report, _, _, _, _, _ := usecase.NewReportRekapitulasiUseCase(t.DB, t.Redis).Export(0, 0, params.F_Periode, params.F_Penggunafilter,
